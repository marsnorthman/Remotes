...
events.detect = function ()
	return 
		libs.fs.exists("C:\\Program Files (x86)\\Vivaldi\\Application")
	or
		libs.fs.exists("C:\\Program Files\\Vivaldi\\Application");
	end


--@help Focus Vivaldi application
...
--@help Launch Vivaldi application
